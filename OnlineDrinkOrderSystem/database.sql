...
Category_Name VARCHAR NOT NULL,-- 类型名称
...
Item_Name VARCHAR NOT NULL,-- 商品名称
Image_Url VARCHAR,-- 商品图片链接
Description VARCHAR NOT NULL,-- 商品描述
...
Google_ID VARCHAR NOT NULL,-- 关联的google id
User_Name VARCHAR NOT NULL,-- 姓名
User_Avater VARCHAR NOT NULL,-- 头像（URL）
Given_Name VARCHAR NOT NULL,-- 名
Family_Name VARCHAR NOT NULL,-- 姓
